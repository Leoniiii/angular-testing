...
describe('HomeComponent', () => {
  ...
  it("should display advanced courses when tab clicked", fakeAsync(() => {
    ...
    /*
     * Tall vez, Call detectChange again instead of use .mat-tab-body-active in By.css function it was necessary because the classname changes when user clicks one of the tabs.
     */
  ...
  it("should display advanced courses when tab clicked - async ", waitForAsync(() => {
    ...
    fixture.detectChanges()
    //Intead of use .mat-tab-body-active in By.css function
